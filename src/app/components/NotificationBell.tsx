...
export function NotificationBell({ variant = 'light', onNotificationClick }: NotificationBellProps) {
              ...
              <div className="divide-y divide-slate-100">
                {notifications.map((notification) => (
                  <div
                    ...
                    } ${notification.type === 'recommendation' ? 'cursor-pointer' : ''}`}
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {notification.type === 'recommendation' && (
                          <p className="text-xs text-[#3D2C8D] mt-1 font-medium">
